...
| :--- | :--- | :--- |
| **[`ai/`](file:///home/luis/nix-config/home/features/ai)** | AI Development & CLI Assistants | `cursor-cli`, `claude-code`, `antigravity-cli` (`agy`), `herdr` agent manager |
...
| **[`programming/`](file:///home/luis/nix-config/home/features/programming)** | Development Toolchains & IDEs | VS Code, VSCodium, RStudio, Python & C++ toolchains, Docker & container tooling |
...
└── programming/             # IDEs, code editors, compiler toolchains & Docker tools
```
